...
<html lang="en">
  ...
  <body>
    ...
    <!-- insert 
    <form class="form-inline" action="insertpayment.php" method="post" name="payments">
    ...
    <button type="submit" class="btn btn-primary mb-2" value="Insert Data">add</button>
    </form> -->
    ...
    ?>
      <tr>
        ...
        <td><?php echo $objResult["orderNumber"]; ?></td>
        <td><?php echo $objResult["orderDate"]; ?></td>
        <td><?php echo $objResult["requiredDate"]; ?></td>
        <td><?php echo $objResult["shippedDate"]; ?></td>
